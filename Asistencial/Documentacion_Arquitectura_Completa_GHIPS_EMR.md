...
> Documento en construcción. Este archivo consolidará la visión completa (general + técnica + datos + seguridad + interoperabilidad + escalabilidad) en un único punto de referencia.
...
4. Modelo de Datos Resumido (Esquemas críticos)
5. Seguridad y Privacidad (matriz de controles)
6. Interoperabilidad (flujos HL7/FHIR clave)
