...
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐      │
│  │ Ghips.Web    │  │ Ghips.WebL   │  │ Presentación │      │
│  │ (ASP.NET)    │  │ (Interna)    │  │ (libGHIPS)   │      │
│  └──────────────┘  └──────────────┘  └──────────────┘      │
└─────────────────────────────────────────────────────────────┘
                            ▼
┌─────────────────────────────────────────────────────────────┐
...
Ver [Documentacion_Arquitectura_General_GHIPS_EMR.md](Documentacion_Arquitectura_General_GHIPS_EMR.md) para detalles completos.
...
| Servicio | Uso |
|----------|-----|
| Azure Storage | Documentos clínicos, backups |
...
│
├── 📚 Documentación/
│   ├── Documentacion_Arquitectura_GHIPS_EMR.md
│   ├── Documentacion_Arquitectura_General_GHIPS_EMR.md
│   ├── Documentacion_Interoperabilidad_GHIPS_EMR.md
│   ├── Documentacion_Seguridad_Privacidad_GHIPS_EMR.md
│   └── Documentacion_Escalabilidad_Desempeno_GHIPS_EMR.md
│
├── 🌐 Presentación/
│   ├── Ips.Gestion.Ghips.Web/               # Aplicación web principal
│   ├── Ips.Gestion.Ghips.WebLocal/          # App interna
│   └── libGHIPS.Presentacion/               # Componentes UI compartidos
│
├── 🔌 Servicios/
...
│
└── 📦 Instaladores/
    ├── Ips.Gestion.Ghips.Installer/
    ├── Ips.Gestion.InstaladoresServicios/
    └── Ips.Gestion.InstaladoresWindows/
```
...
- **Motor:** Microsoft SQL Server 2012+
...
- Cuenta Azure (Storage, AD, Power BI)
- Conectividad a servicios externos (MIPRES, telemedicina)
...
- **[Arquitectura General](Documentacion_Arquitectura_General_GHIPS_EMR.md)** - Visión completa de componentes, datos y tecnologías
- **[Arquitectura Detallada](Documentacion_Arquitectura_GHIPS_EMR.md)** - Descripción profunda de la arquitectura técnica
- **[Interoperabilidad](Documentacion_Interoperabilidad_GHIPS_EMR.md)** - Flujos de integración, protocolos HL7/FHIR, servicios
- **[Seguridad y Privacidad](Documentacion_Seguridad_Privacidad_GHIPS_EMR.md)** - Roles, clasificación de información, controles
- **[Escalabilidad y Desempeño](Documentacion_Escalabilidad_Desempeno_GHIPS_EMR.md)** - Pruebas de carga, métricas, estrategias de escalamiento
...
- **Arquitectura:** arquitectura@ghips.com
- **Soporte Técnico:** soporte@ghips.com
- **Documentación:** docs@ghips.com

### Recursos

- Wiki interna: [enlace interno]
- Base de conocimiento: [enlace interno]
...
**Propietario:** GRUPO DESARROLLO GHIPS  
**Derechos Reservados:** Todos los derechos reservados © 2025  
**Marca:** GHIPS es una marca registrada del GRUPO DESARROLLO GHIPS
...
Desarrollado con ❤️ por el GRUPO DESARROLLO GHIPS para transformar la atención en salud.
...
**[⬆ Volver arriba](#ghips---gestión-hospitalaria-integral-de-procesos-de-salud)**
